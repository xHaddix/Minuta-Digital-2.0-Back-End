              ...
              <tr>
                <td style="padding:32px;">
                  ...
                  <p style="margin:0 0 16px; color:#374151; font-size:14px; line-height:1.6;">
                    ...
                    <strong>Minuta Digital</strong>. Haz clic en el siguiente botón para
                  ...
                  <p style="margin:0; color:#9ca3af; font-size:12px; line-height:1.6;">
                    Este enlace expirará en <strong>${expiresInMinutes} minutos</strong>. Si no
                    solicitaste este cambio, puedes ignorar este mensaje: tu contraseña
